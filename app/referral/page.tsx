...
export default function ReferralPage() {
    ...
    return (
      <div className="min-h-screen bg-[#f7f8fa] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-11 h-11 rounded-none bg-[#0b2742] flex items-center justify-center shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] text-slate-900 pb-24 pt-5 px-3 flex justify-center">
      <div className="w-[calc(100%-1.5rem)] max-w-[calc(28rem-1.5rem)] space-y-4">
        ...
        <header className="flex items-center justify-between">
          <Link
            href="/akun"
            className="group w-10 h-10 rounded-none bg-white border border-slate-200/70 flex items-center justify-center shadow-[0_4px_18px_rgba(15,23,42,0.04)] transition hover:border-slate-300"
          >
          ...
          <div className="w-10 h-10 rounded-none bg-[#102a43] flex items-center justify-center shadow-[0_6px_20px_rgba(16,42,67,0.18)]">
            <Sparkles className="w-[16px] h-[16px] text-[#d8b76a]" />
          </div>
        </header>

        {/* PREMIUM HERO */}
        <section className="relative overflow-hidden rounded-none bg-[#102a43] p-6 shadow-[0_18px_45px_rgba(16,42,67,0.18)]">
          <div className="absolute -right-16 -top-20 w-48 h-48 border border-white/10" />
          <div className="absolute -right-8 -top-12 w-32 h-32 border border-[#d8b76a]/20" />
          <div className="absolute right-5 bottom-5 w-20 h-20 bg-[#d8b76a]/5 blur-2xl" />

          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 rounded-none bg-white/8 border border-white/10 px-3 py-1.5">
              <span className="w-1.5 h-1.5 rounded-none bg-[#d8b76a]" />
        ...
        {/* LOCKED STATE */}
        {!hasPhone ? (
          <section className="bg-white rounded-none border border-slate-200/70 p-6 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
            <div className="flex flex-col items-center text-center">
              <div className="w-14 h-14 rounded-none bg-[#fff8e8] border border-[#f0dfb5] flex items-center justify-center">
              ...
              <Link
                href="/pengaturan"
                className="mt-5 inline-flex items-center justify-center rounded-none bg-[#102a43] px-5 py-3 text-[10px] font-bold uppercase tracking-[0.12em] text-white shadow-lg shadow-[#102a43]/10 transition hover:bg-[#173d5d]"
              >
                Lengkapi Sekarang
              </Link>
            </div>
          ...
          <>
            {/* PERFORMANCE */}
            {statsLoading ? (
              <section className="bg-white rounded-none border border-slate-200/70 p-6 text-center">
              ...
              <section className="bg-white rounded-none border border-slate-200/70 overflow-hidden shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
                <div className="px-5 pt-5 pb-4 flex items-center justify-between">
                  ...
                  <div className="inline-flex items-center gap-1.5 rounded-none bg-emerald-50 border border-emerald-100 px-2.5 py-1">
                ...
                {/* FEE SUMMARY */}
                <div className="m-4 rounded-none bg-[#f8f7f3] border border-[#eee9dc] p-4">
            ...
            {/* LINK GENERATOR */}
            <section className="bg-white rounded-none border border-slate-200/70 p-5 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              <div className="flex items-start justify-between">
                ...
                <div className="w-9 h-9 rounded-none bg-[#f3f6f8] flex items-center justify-center">
              ...
              <div className="mt-5">
                ...
                <div className="mt-2 flex items-center gap-2 p-1.5 rounded-none bg-[#f7f8fa] border border-slate-200">
                  <input
                    type="text"
                    readOnly
                  ...
                  <button
                    ...
                    className={`shrink-0 rounded-none px-3.5 py-2.5 text-[9px] font-bold flex items-center gap-1.5 transition ${
                      copied
              ...
              <div className="mt-5 pt-5 border-t border-slate-100">
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    className="w-full rounded-none bg-[#f7f8fa] border border-slate-200 pl-10 pr-3 py-3 text-[10px] font-medium text-slate-700 outline-none transition focus:border-[#9b7528]"
                  />
                </div>
                ...
                <div className="relative mt-2">
                  <select
                    ...
                    className="appearance-none w-full rounded-none bg-[#f7f8fa] border border-slate-200 px-3.5 py-3 text-[10px] font-semibold text-slate-700 outline-none focus:border-[#9b7528]"
                  >
                    <option value="">
                ...
                {selectedSlug &&
                  (() => {
                    ...
                    return (
                      <div className="mt-3 rounded-none bg-[#f8f7f3] border border-[#eee9dc] p-3.5">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <button
                            ...
                            className={`rounded-none px-3 py-2 text-[9px] font-bold flex items-center gap-1.5 text-white ${
                              copied
                                ? 'bg-emerald-600'
                                : 'bg-[#102a43]'
                            }`}
                        ...
                        <div className="mt-3 rounded-none bg-white border border-slate-200 px-3 py-2.5">
            ...
            <section className="bg-white rounded-none border border-slate-200/70 overflow-hidden shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              ...
              stats.history.length > 0 ? (
                <div className="divide-y divide-slate-100 max-h-72 overflow-y-auto">
                  {stats.history.map(
                    (item: any, idx: number) => (
                      ...
                      >
                        <div className="w-9 h-9 rounded-none bg-emerald-50 flex items-center justify-center shrink-0">
                ...
                <div className="px-5 py-10 text-center">
                  <div className="w-11 h-11 rounded-none bg-slate-50 mx-auto flex items-center justify-center">
